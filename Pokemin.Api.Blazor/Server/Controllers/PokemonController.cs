...
namespace Pokemon.Api.Controllers
{
    ...
    public class PokemonController : ControllerBase
    {
        ...
        /// <summary>
        /// 2 - Busca um Pokémon específico pelo seu nome ou ID na API
        /// </summary>
        ...
        /// <summary>
        /// 1 - Obtém uma lista de Pokémons aleatórios.
        /// </summary>
        ...
        /// <summary>
        /// 3 - Obtém todos os mestres Pokémon registrados no sistema.
        /// </summary>
        /// <returns>O número total de mestres Pokémon registrados no sistema.</returns>
        [HttpGet("masters")]
        #region Swagger Examples Attributes
        [OperationOrder(2)]
        [SwaggerOperation(Tags = new string[] { "Mestres Pokémons" })]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(GetResponseDTO))]
        [SwaggerResponse((int)HttpStatusCode.OK, "OK", typeof(GetResponseDTO))]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError, Type = typeof(GetResponseDTO))]
        [SwaggerResponse((int)HttpStatusCode.InternalServerError, "InternalServerError", typeof(GetResponseDTO))]
        ...
        /// <summary>
        /// 4 - Captura um Pokémon para um mestre Pokémon especificado.
        /// </summary>
        ...
        #region Swagger Examples Attributes
        [OperationOrder(3)]
        [SwaggerOperation(Tags = new string[] { "Captura Pokémon" })]
        ...
        /// <summary>
        /// 5 - Obtém todos os Pokémons capturados filtrando por um mestre ou não.
        /// </summary>
        /// <param name="masterId">O ID do mestre Pokémon.</param>
        /// <returns>O número de Pokémons capturados pelo mestre até o momento.</returns>
